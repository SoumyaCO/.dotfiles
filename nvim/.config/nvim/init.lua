...
-- end)
--
-- Enable extra ui feature for neovim-obsidian
...
vim.keymap.set('n', '<leader>pv', vim.cmd.Ex, { desc = '󰁮 [P]re[V]iou netrw' })
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sh', builtin.help_tags, { desc = '󰋗 [S]earch [H]elp' })
      vim.keymap.set('n', '<leader>sk', builtin.keymaps, { desc = ' [S]earch [K]eymaps' })
      vim.keymap.set('n', '<leader>gf', builtin.git_files, { desc = '󰊢 search [G]it [F]iles' })
      vim.keymap.set('n', '<leader>sf', builtin.find_files, { desc = '󰈞 [S]earch [F]iles' })
  ...
  },
  {
    ...
    vim.keymap.set('n', '<leader>sd', '<cmd>Lspsaga show_workspace_diagnostics<cr>', { desc = '[S]earch [D]iagnostics' }),
...
-- vim.api.nvim_set_hl(0, 'CmpItemKindMethod', { fg = '#fb4934' })
-- vim.api.nvim_set_hl(0, 'CmpItemKindVariable', { fg = '#98c379' })
-- vim.api.nvim_set_hl(0, 'CmpItemKindText', { fg = '#d5c4a1' })

...
alias la="eza --all --long --header"
alias lsize='eza --all --long --header --sort=size --icons'
alias lext='eza --all --long --header --sort=ext --icons'
alias tree="eza --tree --level=2 --git --color=always"
